...
import {MANAGEMENT_NAME} from "../const";
...
export default function PersistentDrawerLeft({children, open, setOpen}) {
    ...
    return (<Box sx={{display: 'flex'}}>
        ...
        <AppBar position="fixed" open={open}>
            <Toolbar>
                ...
                <Typography variant="h6" noWrap component="div">
                    {MANAGEMENT_NAME} management background
                </Typography>
            </Toolbar>
        </AppBar>
        <Drawer
        ...
        <Main open={open} style={{marginTop: '65px'}}>
            {children}
        </Main>
    </Box>);
}
